...
def train_data():
    ...
    main_df['target'] = list(
        map(classify, main_df['close'], main_df['future']))
    ...
    opt = tf.keras.optimizers.legacy.Adam(
        learning_rate=LEARNING_RATE, decay=5e-5)
    ...
    filepath = "LSTM-best"
    formated_filepath = "./models/{}.h5".format(filepath)

    print(formated_filepath)

    checkpoint = ModelCheckpoint(formated_filepath, monitor='val_accuracy',
